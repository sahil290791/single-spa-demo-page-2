...
const url = `https://sahil-single-spa-demo.s3.ap-south-1.amazonaws.com/%40sahil-mfa/single-spa-demo-page-2/${process.env.TRAVIS_COMMIT}/sahil-mfa-single-spa-demo-page-2.js`
  ...
  .get(url, res => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@sahil-mfa/single-spa-demo-page-2`;
